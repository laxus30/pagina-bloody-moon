		...
		<div class="container">
			<div class="row">
				<div class="grid_12">
					...
					<h1><a href="#">Bloody Moon<span>game developer</span></a></h1>
					<nav>
						<ul class="sf-menu">
							<li class="current"><a href="iniciarSesion.php">Iniciar sesión</a></li>
...
<div class="container">
		<form class="myForm">
				En 2012 escribimos nuestro manifiesto: una declaración de quién creíamos que éramos como una empresa joven todavía al comienzo de su viaje. Nos sirvió bien durante muchos años, pero no evolucionó junto con nosotros. Hoy, necesitamos valores que representen lo que queremos ser para nuestro próximo capítulo.
					...
					<br><br>
					Nuestra ambición es que Riot sea el mejor lugar para trabajar para todos aquellos que sienten pasión por nuestra misión.</p>
		</form>
